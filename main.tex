...
\newcommand\fresh[2]{\ensuremath{\OutputMode{#1}\mathrel{\#}\InputMode{#2}}}
...
\newcommand\infers[2]{\ensuremath{\InputMode{#1}\uparrow{\color{Gray}{\OutputMode{#2}}}}}
\newcommand\checks[2]{\ensuremath{\InputMode{#1}\downarrow\InputMode{#2}}}
...
\thanks{Thanks to Bob Harper, Peter Dybjer, Bengt Norstr\"om, Carlo Angiuli and
