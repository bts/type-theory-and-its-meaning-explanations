...
The judgement we have described so far are ``categorical'' in the sense that
...
The next basic proposition is trivial true $\top$, and to make \isprop{\top}
...
hypothetical judgmenet \hyp{\isprop{P\land Q}}{\isprop{P},\isprop{Q}};
...
A direct verification of $P\land Q$ consists in a direct verification of $P$
and a direct verification of $Q$; this validates the assertion of the judgement
...
A direct verification of $P\lor Q$ may be got either from a direct verification
...
And so to have a direct verification of $P\supset Q$ is to have a direct
...
assert the judgment \istrue{P} is to assert that one has a verification of $P$,
