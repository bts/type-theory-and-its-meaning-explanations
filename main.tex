...
Let us amend the meaning explanation for the other judgements; first, typehood,
...
form \infers{x}{A} where $x$ is a variable, or \type\alpha\ where $\alpha$ is a variable:
\begin{quote}
  To know
...
and \checks{N}{\beta}. This corresponds to the following inference rule:
\[
  \infer{
