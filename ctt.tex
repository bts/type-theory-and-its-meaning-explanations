...
judgement is \framebox{\isset{A}}, and its meaning explanation is as follows:
...
canonical verification of \typrod{A}{x}{B} and when two such verifications are
equal. We will say that \lam{x}{E} is a canonical verification of
\typrod{A}{x}{B} just when we know \sequent{\ver{x}{A}}{\ver{E}{B}}; moreover,
that two verifications \lam{x}{E} and \lam{y}{E'} are equal just when
...
\begin{quote}
  ...
  \ver{K}{[\vec{L}/\vec\Gamma_0]A}, you know
  \ver{[K/x]E}{[K/x][\vec{L}/\vec\Gamma_0]B},} and $[\vec{L}/\vec\Gamma_0]N$
  evaluates to a canonical verification $N'$ of $[\vec{L}/\vec\Gamma_0]A$, then
  \ap{\lam{x}{E}}{N'} evaluates to a canonical verification of
