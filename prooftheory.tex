...
give rise to a system of \emph{hereditary substitution}; the purpose of
hereditary substitutions is to provide a way to substitute a normal form into a
term without creating redexes. The hereditary substitutions may be divided into
two groups. First, the structural substitutions which must be given separately
for the operators of each type, $\hsubstm{E}{x}{M}{M'}$ and
