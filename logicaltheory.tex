...
\section{Hypothetical and General Judgement}
...
\framebox{\genj{\vec{x}}{\mathcal{J}}}. The meaning explanation for this new
...
\genj{x}{\hyp{\istrue{A(x)}}{\istrue{B(x)}}}, we term the whole thing a
``hypothetico-general'' judgement. One thing bears clarifying, which is, why do
we write \hyp{\istrue{P}}{\istrue{P}} rather than
\genj{P}{\hyp{\istrue{P}}{\istrue{P}}}?

The former is formally not a single judgement, but rather a \emph{scheme} for
judgements, where $P$ and $Q$ are intended to be replaced with concrete
expressions by the person making use of the inference. On the other hand, the
